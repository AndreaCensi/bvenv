# -*- coding: utf-8 -*-
#
# bvenv documentation build configuration file, created by
...
latex_documents = [
  ('index', 'bvenv.tex', u'bvenv Documentation',
...
man_pages = [
    ('index', 'bvenv', u'bvenv Documentation',
     [u'Andrea Censi'], 1)
]
